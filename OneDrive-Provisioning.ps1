<#
    .SYNOPSIS
    This script provisions OneDrive for Business for users in a Microsoft Entra (Azure) AD tenant.
    It handles OAuth2 authentication with the Microsoft Graph API and checks if PowerShell 7 is installed, installing it if necessary.
    The script also manages OAuth2 authentication with the Microsoft Admin Center to access individual private OneDrive profiles.
